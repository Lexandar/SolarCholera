...
public class BluetoothChatService {
    ...
    private class ConnectedThread extends Thread {
		...
		public void run() {
            ...
            while (true) {
                try {
                    ...
                    tempStr=new String(buffer,0,bytes);
                    mToSendStr=mToSendStr+tempStr;
                    index=mToSendStr.indexOf("#");
                    if (index>=0){
                    	// Send the obtained bytes to the UI Activity
                    	Log.d(TAG, mToSendStr);
                    	tempStr=mToSendStr.substring(0,index);
                       	Bundle data=new Bundle();
                       	int t[]=getIntFromStr(tempStr);
                    //   	Log.d(TAG, "total index"+t.length);
                    	data.putIntArray("Time&Data", getIntFromStr(tempStr));
                		Message msg = new Message();
                		msg.what=MainActivity.MESSAGE_READ;
                		msg.setData(data);
                		mHandler.sendMessage(msg);
                		mToSendStr=mToSendStr.substring(index+1);
                    	try {
							Thread.sleep(10);
        ...
        /** Get four integers from a string. Return t[0]=-1 if the string contains more or less integers;**/
